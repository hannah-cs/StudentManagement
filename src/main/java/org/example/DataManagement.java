            ...
            if (role.equals(UserRole.ADMIN)) {
                ...
                while ((line = reader.readLine()) != null) {
                    ...
                    if (userData.length >= 2) {
                        ...
                        userManagement.adminUsers.add(new AdminUser(username, password));
                    }
                }
                ...
                while ((line = reader.readLine()) != null) {
                    ...
                    if (userData.length >= 2) {
                        String username = userData[0].trim();
                        String password = userData[1].trim();
                        userManagement.teacherUsers.add(new TeacherUser(username, password));
                    }
                }
                ...
                while ((line = reader.readLine()) != null) {
                    ...
                    if (userData.length >= 2) {
                        String username = userData[0].trim();
                        String password = userData[1].trim();
                        userManagement.studentUsers.add(new StudentUser(username, password));
                    }
                }
            }
        } catch (IOException e) {
